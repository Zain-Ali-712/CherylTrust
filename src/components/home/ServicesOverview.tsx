...
const businesses = [
    {
        ...
        subservices: [
            { id: "tt-1", num: "01", title: "Peace Over Pressure", available: "Online & In-Person", tagline: "Peace over pressure — for all animals", desc: "Building a connection of peacefulness, changing the whole relationship between you and your dog which reduces reactivity, anxiety, and confusion. This approach allows your dog to feel safe, understood, and capable of responding calmly in situations that once caused stress.", bullets: ["Works without force, fear, or commands", "Results felt from the very first session", "Available globally via video call", "Suitable for all species"] },
            { id: "tt-2", num: "02", title: "Dog Behaviour & Rehabilitation", available: "In-Person · Wellington", tagline: "Deep behaviour work for complex cases", desc: "Work with Cheryl one-on-one to focus on lasting change, whatever the issue. Her specialty is reactive and anxious dogs, helping you support your dog to respond differently. For new puppies or newly adopted dogs, you can proactively prevent common issues by booking a Set-Up Session, ensuring your dog thrives in their new environment and routine.", bullets: ["Aggression, biting & resource guarding", "Separation anxiety & car sickness", "Trauma & PTSD recovery", "Rescue & new puppy setup"] },
    ...
    },
    {
        ...
        subservices: [
            ...
            { id: "ch-2", num: "02", title: "Trust Technique Consult for Clients", available: "Private Coaching", tagline: "Tailored to your needs", desc: "Private coaching tailored to behavioural challenges such as trauma, aggression, PTSD, and adoption transitions.", bullets: ["Targeted behavioral help", "Spooking and floating issues", "Adoption transitions", "Private 1-on-1 focus"] },
