...
const businesses = [
    ...
    },
    {
        ...
        name: "Adventure Park",
        subservices: [
            { id: "adv-1", num: "01", title: "Canine Country Club Membership", available: "Yearly Access", tagline: "Exclusive park access", desc: "Join our private membership for responsible dog owners. Grants you access to book the Adventure Park, Swim Spot, and farm walks.", bullets: ["Private booking access", "Secure environment", "Seasonal Swim Spot", "All breeds welcome"] },
            ...
            { id: "adv-3", num: "03", title: "Off-Leash Enrichment", available: "Adventure Park", tagline: "Explore, sniff, and play", desc: "Exploration and off-lead fun activities that enrich your dog's day. Features include a confidence course, a sensory garden, and agility jumps.", bullets: ["Confidence course included", "Sensory garden exploration", "Agility jumps", "Mental and physical fun"] },
    ...
    },
    {
        ...
        subservices: [
            { id: "ch-1", num: "01", title: "Trust Technique - Foundation Programme", available: "Dogs & Horses", tagline: "Deep nervous system connection", desc: "A comprehensive program teaching you and your animal to share a deep nervous system connection, eliminating fear-based reactions and building unshakeable confidence.", bullets: ["Eliminate fear-based reactions", "Build deep connection", "Comprehensive coaching", "For both dogs and horses"] },
            { id: "ch-2", num: "02", title: "Trust Technique Consult for Clients", available: "Private Coaching", tagline: "Tailored to your needs", desc: "Private coaching tailored to specific behavioral challenges, spooking, floating issues, trauma, and adoption transitions.", bullets: ["Targeted behavioral help", "Spooking and floating issues", "Adoption transitions", "Private 1-on-1 focus"] },
            { id: "ch-3", num: "03", title: "Puppy / New Adopted Dog Set Up", available: "Dog Services", tagline: "Start your relationship off right", desc: "Learn how to introduce your new dog to your home, family, and other animals with absolute peace and clarity.", bullets: ["Home introduction", "Family integration", "Peaceful boundaries", "Set up for success"] },
            { id: "ch-4", num: "04", title: "Emergency Assistance Consult", available: "Acute Support", tagline: "When you need it most", desc: "Immediate support and guidance for sudden behavioral issues, injuries, or when you are navigating an acute crisis with your animal.", bullets: ["Immediate guidance", "Sudden behavioral changes", "Post-injury trauma", "Acute crisis support"] }
        ]
    },
    {
        id: "contact-care",
        ...
        subservices: [
            { id: "cc-1", num: "01", title: "ConTact C.A.R.E for Dogs", available: "Small Animals", tagline: "Practical physical relief", desc: "A practical method for releasing trapped physical pressure and tension in dogs and other small animals. We ensure the body is as comfortable as the mind.", bullets: ["Releases trapped pressure", "Improves comfort", "Non-invasive bodywork", "For dogs & small animals"] },
